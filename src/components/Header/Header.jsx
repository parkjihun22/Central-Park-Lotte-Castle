...
const T = {
  ...
  mainMenu: "주요 메뉴",
  logoAlt: "중앙공원 롯데캐슬 로고",
  bannerAlt: "중앙공원 롯데캐슬 방문예약 안내 배너",
};
...
const menuArray = [
  ...
  // },
  {
    title: "타입안내",
    subMenu: [
      { subTitle: "1BL 평면도 ", subUrl: "/FloorPlan/59A" },
      { subTitle: "2-1BL 평면도", subUrl: "/FloorPlan/59B" },
      { subTitle: "2-2BL 평면도", subUrl: "/FloorPlan/84A" },
