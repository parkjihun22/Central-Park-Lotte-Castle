        ...
        <section className={styles.pressHero} aria-labelledby="pressTitle">
          <div>
            ...
            <p className={styles.pressLead}>
              광주 중앙공원 1지구의 1BL·2-1BL·2-2BL 공급 정보부터
              입지환경, 블록별 평면도, 모델하우스 방문예약까지
              중앙공원 롯데캐슬의 공식 보도자료와 분양 소식을 전합니다.
            </p>
          ...
          <div className={styles.pressStats} aria-label="중앙공원 롯데캐슬 주요 정보">
            <div>
