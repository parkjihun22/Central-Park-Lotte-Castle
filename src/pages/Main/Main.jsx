      ...
      {!isMobile ? (
        ...
        <>
          ...
          <p className={styles.heroDesc}>
            광주광역시 서구 화정동·금호동·풍암동 일원에서 만나는
            <br />
            중앙공원 롯데캐슬 시그니처 브랜드 프리미엄
            <br />
            블록별 분양가·잔여세대 상담부터 모델하우스 방문예약까지
            <br />
            한 번에 확인하세요
          </p>
            <button
