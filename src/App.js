  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/BusinessGuide/intro/:blockId" element={<BusinessGuide1 />} />
        ...
        <Route path="/ComplexGuide/intro/:blockId" element={<ComplexGuide1 />} />
        <Route path="/ComplexGuide/detailintro" element={<ComplexGuide2 />} />
        <Route path="/ComplexGuide/detailintro/:blockId" element={<ComplexGuide2 />} />
        <Route path="/ComplexGuide/community" element={<ComplexGuide3 />} />
        <Route path="/ComplexGuide/community/:blockId" element={<ComplexGuide3 />} />
